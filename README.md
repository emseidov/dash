...
* [`src/dash/`](src/dash/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/dash/core.cljs): contains the SPA entry point, `init`
...
5. Clone this repo and open a terminal in the `dash` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/dash/config.cljs) defaults to `true` in
